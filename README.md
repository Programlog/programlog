...
<!--
**Programlog/programlog** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
## Skills
- **Languages**: Python, C, Java, Typescript, Next.js, Kotlin, SQL, Cuda
- **Tools**: Git, Docker, Kubernetes, Prisma
- **Frameworks**: React, Flask, Vector Database, RESTful API, ML, Neural Networks, LLMs, Agents
